...
eta_data = [
    ("COLOMBO RDHS", "COLOMBO", 0.6),
    ("HORANA DGH", "KALUTARA", 0.6),
    ("PIMBURA BH", "KALUTARA", 0.7),
    ("WARAKAGODA PMCU", "KALUTARA", 1.2),
    ("ANDIAMBALAMA PMCU", "GAMPAHA", 1.2),
    ("KALAGEDIHENA PMCU", "GAMPAHA", 0.9),
    ("NARISSA PMCU", "RATNAPURA", 1.4),
    ("MOLKAWA PMCU", "KALUTARA", 1.5),
    ("YATTAPATHA PMCU", "KALUTARA", 1.3),
    ("EHELIYAGODA BH", "RATNAPURA", 1.3),
    ("WARAKAPOLA BH", "KEGALLE", 1.8),
    ("MAWANELLA BH", "KEGALLE", 2.1),
    ("KARAWANELLA BH", "KEGALLE", 2.4),
    ("HALVITIGALA PMCU", "GALLE", 2.2),
    ("KEGALLE DGH", "KEGALLE", 1.8),
    ("KEGALLE RDHS", "KEGALLE", 1.8),
    ("BALAPITIYA BH", "GALLE", 1.4),
    ("BALAPITIVA BH", "GALLE", 1.4),
    ("ELPITIYA BH", "GALLE", 1.2),
    ("GALLE NATIONAL HOSPITAL", "GALLE", 1.6),
    ("GALLE ROHS", "GALLE", 1.6),
    ("HIKKADUWA DH", "GALLE", 1.6),
    ("FOR WOMEN", "GALLE", 1.5),
    ("POTHUPITIYA DH", "RATNAPURA", 2.2),
    ("RATHNAPURA TEACHING HOSPITAL", "RATNAPURA", 1.6),
    ("RATHNAPURA RDHS", "RATNAPURA", 1.6),
    ("KOLAMBAGEARA PMCU", "RATNAPURA", 1.9),
    ("PERADENIYA TEACHING HOSPITAL", "KANDY", 2.5),
    ("GAMPOLA BH", "KANDY", 2.8),
    ("DERANGALA PMCU", "MATARA", 2.6),
    ("ROTAMBA PMCU", "MATARA", 2.6),
    ("KIRINDA PUHULWELLA DH", "MATARA", 1.9),
    ("ALUPOLA DH", "RATNAPURA", 3.1),
    ("KANDY NATIONAL HOSPITAL", "KANDY", 2.7),
    ("MATARA DGH", "MATARA", 1.9),
    ("BELIATTE DH", "HAMBANTOTA", 2.3),
    ("BELIIATTE DH", "HAMBANTOTA", 2.6),
    ("KALAWANA BH", "RATNAPURA", 1.9),
    ("WALASMULLA BH", "HAMBANTOTA", 2.4),
    ("DAMBULLA BH", "MATALE", 3.1),
    ("MATALE DGH", "MATALE", 3.2),
    ("MATALE RDHS", "MATALE", 3.2),
    ("BERALIHERA PMCU", "HAMBANTOTA", 3.0),
    ("HAMBANTOTA DGH", "HAMBANTOTA", 2.9),
    ("PALLEGAMA DH", "MATARA", 2.5),
    ("RANNA DH", "HAMBANTOTA", 2.6),
    ("TANGALLE BH", "HAMBANTOTA", 2.4),
    ("MINUWANGETE PMCU", "KURUNEGALA", 1.8),
    ("KULIYAPITIYA TEACHING HOSPITAL", "KURUNEGALA", 2.2),
    ("PALAMKOTTE DH", "RATNAPURA", 3.0),
    ("THELDENIYA BH", "KANDY", 3.3),
    ("RAMBUKEWELA PMCU", "KANDY", 3.0),
    ("KAMBURUPITIYA BH", "MATARA", 1.9),
    ("DERANIYAGALA DH", "KEGALLE", 1.5),
    ("BELIGALA DH", "KEGALLE", 1.7),
    ("MAHAPALLEGAMA DH", "KEGALLE", 1.7),
    ("KIRIPORUWA WATTA (ERH) DH", "KEGALLE", 2.1),
    ("MARAMBA DH", "MATARA", 1.9),
    ("DENIYAYA BH", "MATARA", 2.8),
    ("LANKAGAMA PMCU", "GALLE", 3.1),
    ("UDUGAMA BH", "GALLE", 2.3),
    ("UDUGAMA 8H", "GALLE", 2.3),
    ("NELUWA DH", "GALLE", 2.0),
    ("CHILAW DGH", "PUTTALAM", 1.9),
    ("MARAWILA BH", "PUTTALAM", 1.8),
    ("THISSAMAHARAMAYA BH", "HAMBANTOTA", 3.2),
    ("DAMBADENIYA BH", "KURUNEGALA", 2.3),
    ("KURUNEGALA TEACHING HOSPITAL", "KURUNEGALA", 2.0),
    ("KEKUNAGALLA PMCU", "KURUNEGALA", 2.1),
    ("WESTHALL DH", "KANDY", 2.6),
    ("NIKAWERATIYA BH", "KURUNEGALA", 3.0),
    ("KATUPOTHA DH", "KURUNEGALA", 2.2),
    ("PUTTALAM BH", "PUTTALAM", 3.1),
    ("TPUTTALAM BH", "PUTTALAM", 3.1),
    ("PUTTALAM CHEST", "PUTTALAM", 3.1),
    ("RAMBODA KOTMALE DH", "NUWARA ELIYA", 3.2),
    ("PAHALAGIRIBAWA DH", "KURUNEGALA", 3.9),
    ("ANDIYAGALA DH", "ANURADHAPURA", 3.4),
    ("DICKOYA BH", "NUWARA ELIYA", 2.6),
    ("KOTAGALA DH", "NUWARA ELIYA", 2.4),
    ("LINDULA DH", "NUWARA ELIYA", 2.4),
    ("NUWARA ELIYA DGH", "NUWARA ELIYA", 3.3),
    ("MORAHENA DH", "KANDY", 3.2),
    ("MENIKHINNA DH", "KANDY", 3.0),
    ("KOLONGODA DH", "KANDY", 2.9),
    ("KAHAWATTA BH", "RATNAPURA", 2.9),
    ("USGALA SIYABALANGAMUWA PMCU", "KURUNEGALA", 3.7),
    ("GALGAMUWA BH", "KURUNEGALA", 3.7),
    ("RIKILLAGASKADA BH", "NUWARA ELIYA", 3.1),
    ("YATAWATHTHA DH", "MATALE", 4.3),
    ("URUBOKKA DH", "MATARA", 2.6),
    ("PATTIYAGAMA PALLEGAMA DH", "KANDY", 3.2),
    ("ANURADHAPURA TEACHING HOSPITAL", "ANURADHAPURA", 4.5),
    ("ANURADHAPURA RDHS", "ANURADHAPURA", 4.5),
    ("KEKIRAWA BH", "ANURADHAPURA", 3.7),
    ("HABARANA DH", "ANURADHAPURA", 4.3),
    ("MAHAGIRILLA DH", "KURUNEGALA", 3.4),
    ("RAJANGANAYA DH", "KURUNEGALA", 4.2),
    ("ALUTHWEWA PMCU", "MATALE", 4.5),
    ("OPALGALA PMCU", "MATALE", 4.3),
    ("WALAPANE DH", "NUWARA ELIYA", 3.4),
    ("GONAPITIYA DH", "NUWARA ELIYA", 3.5),
    ("AGARAPATHANA DH", "NUWARA ELIYA", 3.1),
    ("NORTH MEDAKUMBURA DH", "NUWARA ELIYA", 3.2),
    ("SANGARAJAPURA DH", "KANDY", 3.6),
    ("MAHIYANGANAYA BH", "BADULLA", 4.5),
    ("WELIMADA BH", "BADULLA", 3.9),
    ("DAMBETENNA DH", "BADULLA", 3.2),
    ("ANAWILUNDAWA DH", "PUTTALAM", 3.5),
    ("KOTTUKACHCHIYA DH", "PUTTALAM", 4.0),
    ("MUNDALAMA MOH", "PUTTALAM", 3.8),
    ("NIKAWEWA DH", "KURUNEGALA", 3.8),
    ("UDAGAMA ATABAGE DH", "KANDY", 4.4),
    ("GALPIHILLA DH", "KANDY", 4.8),
    ("BANDARAWELA BH", "BADULLA", 3.7),
    ("HAMBEGAMUWA DH", "MONERAGALA", 3.6),
    ("MULOYA DH", "NUWARA ELIYA", 4.4),
    ("UPCOT PMCU", "NUWARA ELIYA", 3.1),
    ("GLANMORE DH", "BADULLA", 3.3),
    ("KEPPETIPOLA PMCU", "BADULLA", 3.9),
    ("LAGGALA PALLEGAMA MOH", "MATALE", 4.4),
    ("BADULLA TEACHING HOSPITAL", "BADULLA", 4.4),
    ("NOCHCHIYAGAMA DH", "ANURADHAPURA", 4.5),
    ("THAMBUTTEGAMA BH", "ANURADHAPURA", 4.0),
    ("GALNEWA DH", "ANURADHAPURA", 4.5),
    ("AYAGAMA DH", "RATNAPURA", 2.1),
    ("WELKENIYAYA PMCU", "RATNAPURA", 2.7),
    ("EMBILIPITIYA DGH", "RATNAPURA", 2.7),
    ("WANATHAWILLUWA DH", "PUTTALAM", 5.8),
    ("DAYAGAMA WEST DH", "NUWARA ELIYA", 3.4),
    ("RIDEEMALIYADDA MOH", "BADULLA", 5.6),
    ("UVA PARANAGAMA DH", "BADULLA", 4.6),
    ("DIYATHALAWA BH", "BADULLA", 4.1),
    ("POLONNARUWA DGH", "POLONNARUWA", 4.5),
    ("POLONNARUWA RDHS", "POLONNARUWA", 4.5),
    ("POLONNARUWA RENAL HOSPITAL", "POLONNARUWA", 4.5),
    ("BIBILE BH", "MONERAGALA", 5.4),
    ("KATHARAGAMA DH", "MONERAGALA", 3.6),
    ("BUTHTHALA DH", "MONERAGALA", 4.4),
    ("GIRANDURUKOTTE DH", "BADULLA", 5.2),
    ("ATHTHANAKADAWALA DH", "POLONNARUWA", 4.9),
    ("PULASTHIGAMA (BOP 400) DH", "POLONNARUWA", 4.9),
    ("MEEMURE PMCU", "KANDY", 4.8),
    ("NADUMGAMUWA DH", "BADULLA", 4.7),
    ("THENNAPANGUWA PMCU", "BADULLA", 5.3),
    ("THANTIRIMALE DH", "ANURADHAPURA", 4.5),
    ("MEDIRIGIRIYA BH", "POLONNARUWA", 4.9),
    ("SEVANAPITIYA PMCU", "POLONNARUWA", 5.1),
    ("ARALAGANWILA DH", "POLONNARUWA", 4.9),
    ("DIMBULAGALA MANAMPITIYA DH", "POLONNARUWA", 4.9),
    ("PADAVIYA BH", "ANURADHAPURA", 6.0),
    ("WAHALKADA DH", "ANURADHAPURA", 5.4),
    ("HATTOTA AMUNA DH", "MATALE", 4.3),
    ("MARAKA DH", "MATALE", 5.4),
    ("MONERAGALA DGH", "MONERAGALA", 4.4),
    ("MONERAGALA RDHS", "MONERAGALA", 4.4),
    ("RUPAHA PMCU", "NUWARA ELIYA", 4.3),
    ("KALAGANWATTA PMCU", "NUWARA ELIYA", 4.3),
    ("AAMBAGAHAPELESSA DH", "KANDY", 4.7),
    ("BATUMULLA DH", "KANDY", 4.8),
    ("LUNUGALA DH", "BADULLA", 5.1),
    ("SIYAMBALANDUWA BH", "MONERAGALA", 5.9),
    ("AMPARA DGH", "AMPARA", 6.5),
    ("AMPARA RDHS", "AMPARA", 6.5),
    ("DEHIATTAKANDIYA BH", "AMPARA", 7.7),
    ("MAHAOYA BH", "AMPARA", 6.6),
    ("PADIYATALAWA DH", "AMPARA", 7.2),
    ("KANTALE BH", "TRINCOMALEE", 4.6),
    ("KANTALE 8H", "TRINCOMALEE", 4.6),
    ("KUNCHUKULAM PMCU", "ANURADHAPURA", 6.3),
    ("KOTIYAGALA PMCU", "MONERAGALA", 5.8),
    ("INGINIYAGALA DH", "MONERAGALA", 6.2),
    ("VANKALAI DH", "MANNAR", 6.7),
    ("MURUNKAN BH", "MANNAR", 6.4),
    ("NEDUNKERNY DH", "VAVUNIYA", 6.6),
    ("WELIOYA MOH", "MULLAITIVU", 7.4),
    ("SERUWILA DH", "TRINCOMALEE", 6.1),
    ("GOMARANKADAWELA DH", "TRINCOMALEE", 6.2),
    ...
    ("CHEDDIKULAM BH", "VAVUNIYA", 6.9),
    ("ECHCHANKULAM PMCU", "VAVUNIYA", 6.4),
    ("NERIYAKULAM DH", "VAVUNIYA", 5.8),
    ("MANNAR DGH", "MANNAR", 6.8),
    ("MANNAR RDHS", "MANNAR", 6.8),
    ("TAMPITIYA PMCU", "AMPARA", 7.4),
    ("VIDATHALTIVU DH", "MANNAR", 7.0),
    ("PERIYAMADHU PMCU", "MANNAR", 7.3),
    ("MANALCHENAI PMCU", "TRINCOMALEE", 5.4),
    ("PADAVISIRIPURA DH", "TRINCOMALEE", 7.2),
    ("KILIVETTY DH", "TRINCOMALEE", 5.4),
    ("KILIVETTY OH", "TRINCOMALEE", 5.4),
    ("MUTHUR BH", "TRINCOMALEE", 5.6),
    ("PULMODAI BH", "TRINCOMALEE", 6.4),
    ("KINNIYABH", "TRINCOMALEE", 5.6),
    ("THARAPURAM PMCU", "MANNAR", 7.1),
    ("POONAKERY DH", "KILINOCHCHI", 8.0),
    ("POONAKERY POONARYN DH", "KILINOCHCHI", 8.0),
    ("THALAIMANNAR DH", "MANNAR", 7.4),
    ("ERUKALAMPIDDY DH", "MANNAR", 7.2),
    ("SAMPOOR DH", "TRINCOMALEE", 6.0),
    ("MANKULAM BH", "MULLAITIVU", 6.8),
    ("NADDANKANDAL DH", "MULLAITIVU", 7.4),
    ("NANDANKANNDAL DH", "MULLAITIVU", 7.4),
    ("SENARATHPURA DH", "AMPARA", 6.4),
    ("ISENARATHPURA DH", "AMPARA", 6.4),
    ("LAHUGALA MOH", "AMPARA", 5.5),
    ("WEERAGODA PMCU", "AMPARA", 7.0),
    ("IRAKKAMAM DH", "KALMUNAI", 6.3),
    ("IRAKKAMAM ERAGAMA DH", "KALMUNAI", 6.3),
    ("VALAICHCHENAI BH", "BATTICALOA", 6.4),
    ("VALAICHCHENA! BH", "BATTICALOA", 6.4),
    ("CHENKALADY DH", "BATTICALOA", 6.2),
    ("KATHIRAVELY DH", "BATTICALOA", 7.4),
    ("MALLAVI BH", "MULLAITIVU", 7.1),
    ("KILINOCHCHI DGH", "KILINOCHCHI", 7.2),
    ("PALAI DH", "KILINOCHCHI", 7.7),
    ("THUNUKKAI PMCU", "MULLAITIVU", 7.4),
    ("ERAVUR BH", "BATTICALOA", 6.6),
    ("KALMUNAI NORTH BH", "KALMUNAI", 7.1),
    ("KALUWANCHIKUDY BH", "BATTICALOA", 7.0),
    ("KATTANKUDY BH", "BATTICALOA", 6.9),
    ("ODDUSUDDAN DH", "MULLAITIVU", 6.9),
    ("MULLAITIVU DGH", "MULLAITIVU", 7.5),
    ("PALUGAMAM DH", "BATTICALOA", 7.4),
    ("HOSPITAL", "KALMUNAI", 7.1),
    ("BATTICALOA TEACHING HOSPITAL", "BATTICALOA", 6.7),
    ("MEERAVODAI DH", "BATTICALOA", 6.9),
    ("JAFFNA TEACHING HOSPITAL", "JAFFNA", 8.6),
    ("JAFFNA RDHS", "JAFFNA", 8.6),
    ("CHAVAKACHCHERI BH", "JAFFNA", 8.2),
    ("GURUNAGAR DH", "JAFFNA", 8.4),
    ("KODIKAMAM DH", "JAFFNA", 8.5),
    ("INUVIL PMCU", "JAFFNA", 8.6),
    ("KAYTS BH", "JAFFNA", 7.0),
    ("MULLIYAN PMCU", "JAFFNA", 8.0),
    ("DEEGAWAPIYA DH", "KALMUNAI", 6.6),
    ("ANNAMALAI DH", "KALMUNAI", 7.2),
    ("ULLAI PMCU", "KALMUNAI", 5.9),
    ("THIRUKKOVIL BH", "KALMUNAI", 6.5),
    ("AKKARAIPATTU BH", "KALMUNAI", 6.8),
    ("SAMMANTHURAI BH", "KALMUNAI", 6.9),
    ("SAMMANTHURA! MOH", "KALMUNAI", 6.9),
    ("MANDUR DH", "BATTICALOA", 7.1),
    ("MAVADIVAMBU VANTHARAMOOLAIDH", "BATTICALOA", 6.2),
    ("NINTAVUR BH", "KALMUNAI", 7.1),
    ("NAWALKADU DH", "BATTICALOA", 6.7),
    ("TELLIPPALAI BH", "JAFFNA", 8.6),
    ("TELLIPPALAI MOH", "JAFFNA", 8.6),
    ("KANKASANTHURAI PMCU", "JAFFNA", 8.9),
    ("POINT PEDRO BH", "JAFFNA", 8.5),
    ("POINT PEDRO PMCU", "JAFFNA", 8.5),
    ("THOLPURAM PMCU", "JAFFNA", 8.0),
    ("ALAMPIL DH", "MULLAITIVU", 7.8),
    ("PUTHUKKUDYIRUPPU BH", "MULLAITIVU", 7.7),
    ("POTTUVIL BH", "KALMUNAI", 6.4),
    ("PANAMA DH", "AMPARA", 6.3),
